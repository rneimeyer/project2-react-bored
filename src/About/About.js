    ...
    <div className="page-container">
      ...
      <div className={`about ${colorTheme}`}>
        ...
        <p>
          ...
          showcase my knowledge of React and rendering data from the <a href="https://www.boredapi.com" target="_blank" rel="noreferrer">Bored API</a>. I hope
          this helps you find a fun activity to do when you are bored!
        </p>
        <p>Please feel free to get in touch with me via <a href="https://www.linkedin.com/in/rebecca-neimeyer" target="_blank" rel="noreferrer">LinkedIn</a>!</p>
        </div>
        ...
        <Card style={{ width: "18rem" }} className="mx-auto">
          <Card.Body>
            ...
            <br />
            <Card.Text>
              Accessibility Range: How possible is this to accomplish on a scale
              of 1-10? Below shows a 5/10 on the scale.
            </Card.Text>
            <ProgressBar now={50} />
          </Card.Body>
        </Card>
